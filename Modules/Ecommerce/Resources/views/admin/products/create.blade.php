                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="crancy__item-form--group w-100 h-100">
                                                                ...
                                                                <div class="crancy-product-card__upload crancy-product-card__upload--border">
                                                                    ...
                                                                    <label class="crancy-image-video-upload__label" for="input-img1">
                                                                        <img id="view_img" src="{{ isset($product) && $product->thumbnail_image ? asset($product->thumbnail_image) : asset($general_setting->placeholder_image) }}">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                                ...
                                                                <input class="crancy__item-input" type="text" name="name" id="name" value="{{ old('name', $product->name ?? '') }}">
                                                            </div>
                                                            <div class="crancy__item-form--group mg-top-form-20">
                                                    ...
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <select class="form-select crancy__item-input" name="brand_id" id="brand_id">
                                                            ...
                                                            @foreach ($brands as $brand)
                                                                <option value="{{ $brand->id }}" {{ (isset($product) && $product->brand_id == $brand->id) ? 'selected' : '' }}>{{ $brand->translate->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <select class="form-select crancy__item-input" name="category_id" id="category_id">
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->id }}" {{ (isset($product) && $product->category_id == $category->id) ? 'selected' : '' }}>{{ $category->translate->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box" name="short_description" id="short_description">{{ old('short_description', $product->translate->short_description ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        ...
                                                        <input class="crancy__item-input" type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', $product->translate->seo_title ?? '') }}">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="crancy__item-form--group mg-top-form-20">
                                                        <label class="crancy__item-label">{{ __('translate.SEO Description') }} </label>
                                                        <textarea class="crancy__item-input crancy__item-textarea seo_description_box" name="seo_description" id="seo_description">{{ old('seo_description', $product->translate->seo_description ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="crancy-btn mg-top-25" type="submit">{{ isset($product) ? __('translate.Update Data') : __('translate.Save Data') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('style_section')
    ...
    <style>
        ...
        .crancy-radio-label input[type="radio"]:checked + span strong { color: #2b4dff; }
